...
var On = (s, e, i) => e in s ? Nn(s, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : s[e] = i;
var Vs = (s, e, i) => On(s, typeof e != "symbol" ? e + "" : e, i);
var An = Object.defineProperty, gn = (s, e, i) => e in s ? An(s, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : s[e] = i, k = (s, e, i) => gn(s, typeof e != "symbol" ? e + "" : e, i);
function In(s) {
...
(function(s) {
  ...
  function h(a, _, u, E, l) {
    ...
    var f = new r(u, E || a, l), T = i ? i + _ : _;
    return a._events[T] ? a._events[T].fn ? a._events[T] = [a._events[T], f] : a._events[T].push(f) : (a._events[T] = f, a._eventsCount++), a;
  }
  function o(a, _) {
  ...
  c.prototype.eventNames = function() {
    ...
    var N = this._events[T], d = arguments.length, O, A;
    if (N.fn) {
      switch (N.once && this.removeListener(a, N.fn, void 0, !0), d) {
        case 1:
      ...
      for (A = 1, O = new Array(d - 1); A < d; A++)
        O[A - 1] = arguments[A];
      N.fn.apply(N.context, O);
    } else {
      var g = N.length, R;
      for (A = 0; A < g; A++)
        switch (N[A].once && this.removeListener(a, N[A].fn, void 0, !0), d) {
          case 1:
          ...
          case 4:
            ...
            break;
          default:
            if (!O) for (R = 1, O = new Array(d - 1); R < d; R++)
              O[R - 1] = arguments[R];
    ...
    if (f.fn)
      ...
      for (var T = 0, N = [], d = f.length; T < d; T++)
        (f[T].fn !== _ || E && !f[T].once || u && f[T].context !== u) && N.push(f[T]);
...
var Ln = 4, mn = 1e-3, Cn = 1e-7, xn = 10, qt = 11, ss = 1 / (qt - 1), Sn = typeof Float32Array == "function";
function Wi(s, e) {
  return 1 - 3 * e + 3 * s;
}
function ki(s, e) {
...
function cs(s, e, i) {
  return ((Wi(e, i) * s + ki(e, i)) * s + Xi(e)) * s;
}
function vi(s, e, i) {
  return 3 * Wi(e, i) * s * s + 2 * ki(e, i) * s + Xi(e);
}
function Mn(s, e, i, n, r) {
  var h, o, c = 0;
  do
    o = e + (i - e) / 2, h = cs(o, n, r) - s, h > 0 ? i = o : e = o;
  while (Math.abs(h) > Cn && ++c < xn);
  return o;
}
function Dn(s, e, i, n) {
  for (var r = 0; r < Ln; ++r) {
...
var wn = function(s, e, i, n) {
  if (!(0 <= s && s <= 1 && 0 <= i && i <= 1))
    throw new Error("bezier x values must be in [0, 1] range");
  if (s === e && i === n)
    return Pn;
  for (var r = Sn ? new Float32Array(qt) : new Array(qt), h = 0; h < qt; ++h)
    r[h] = cs(h * ss, s, i);
  function o(c) {
    for (var a = 0, _ = 1, u = qt - 1; _ !== u && r[_] <= c; ++_)
      a += ss;
    --_;
    var E = (c - r[_]) / (r[_ + 1] - r[_]), l = a + E * ss, f = vi(l, s, i);
    return f >= mn ? Dn(c, l, s, i) : f === 0 ? l : Mn(c, a, a + ss, s, i);
  }
  return function(c) {
    return c === 0 ? 0 : c === 1 ? 1 : cs(o(c), e, n);
  };
};
const pn = /* @__PURE__ */ In(wn), yn = [0, 0, 1, 1], Hs = (s, e) => {
  if (e <= s[0].time)
    return {
      startFrame: s[0],
      endFrame: s[0],
...
class Un {
  ...
  interpolate(e) {
    const i = Math.max(0, Math.min(1, e)) * this.duration, {
      ...
      endFrame: r,
      progress: h
    } = Hs(this.sortedKeyframes, i), o = r.easing ? Gn(r.easing, h) : h, c = {
  ...
  insertKF(e) {
    ...
    const { progress: n } = Hs(this.sortedKeyframes, e.time), r = this.sortedKeyframes.findIndex((h) => h.time > e.time);
    if (r !== 0 && r !== -1) {
      const h = this.sortedKeyframes[r];
      if (h.easing)
        if (h.easing.length === 4) {
          const o = h.easing, c = n, a = 0, _ = 0, u = o[0], E = o[1], l = o[2], f = o[3], T = 1, N = 1, d = 1 - c, O = d * a + c * u, A = d * _ + c * E, g = d * u + c * l, R = d * E + c * f, I = d * l + c * T, S = d * f + c * N, C = d * O + c * g, M = d * A + c * R, P = d * g + c * I, p = d * R + c * S, D = d * C + c * P, G = d * M + c * p, w = [a, _, O, A, C, M, D, G], b = [D, G, P, p, I, S, T, N], v = w[6] - w[0], X = w[7] - w[1], H = [
            w[2] / v,
            w[3] / X,
            w[4] / v,
            w[5] / X
          ], F = b[6] - b[0], V = b[7] - b[1], U = [
            (b[2] - b[0]) / F,
            (b[3] - b[1]) / V,
            (b[4] - b[0]) / F,
            (b[5] - b[1]) / V
  ...
  _resolve(e, i = !1) {
    ...
    if (this.animations.length > 1) {
      if (n.isForward()) {
        ...
        const l = e + n.currentTime, f = Rs(
          this.AC,
          l,
          this.key,
          this.animations,
          1
        ), T = a ? c : [{ time: 0, value: f }, ...c], N = this.AC.keyframeComposer.compose(
          o,
          T,
          r
        );
...
const Rs = (s, e, i, n, r) => {
  ...
  if (r >= n.length)
    return h;
  const o = n[r], { duration: c } = o.trackData, { time: a, state: _ } = o.getStatus(e), u = o.getPropTrack(i), { type: E, kfs: l } = u, f = l.some((T) => T.time === 0);
  if (o.isForward())
...
class kn {
  ...
  tick() {
    ...
    for (const [i, n] of this.animations) {
      if (n.isEnded() && this.deleteAnimation(i), n.isPaused())
        continue;
  ...
  playAnimation(e, i) {
    ...
    if (n && !i.backward && (n.isForward() || n.isCompleted()) && this.deleteAnimation(e), n = this.animations.get(e), !n) {
      ...
      n = new Fn(e, r), this.animations.set(e, n);
    }
  ...
  deleteAnimation(e) {
    ...
    if (i) {
      ...
      for (const [n] of i.trackData.tracks) {
        const r = this.getPropertyEffect(n);
        r && (r.deleteAnimation(this.currentTime, i), r.animations.length === 0 && (this.setComputedData(n, this.getBaseValue(n)), this.propertyEffects.delete(n)));
      }
    }
  }
  // transfer version 1
...
function $n(s, e, i = Wt) {
  const n = s[0], r = s[1], h = s[2], o = s[3], c = s[4], a = s[5], _ = e[0], u = e[1], E = e[2], l = e[3], f = e[4], T = e[5];
  return Math.abs(n - _) <= i * Math.max(1, Math.abs(n), Math.abs(_)) && Math.abs(r - u) <= i * Math.max(1, Math.abs(r), Math.abs(u)) && Math.abs(h - E) <= i * Math.max(1, Math.abs(h), Math.abs(E)) && Math.abs(o - l) <= i * Math.max(1, Math.abs(o), Math.abs(l)) && Math.abs(c - f) <= i * Math.max(1, Math.abs(c), Math.abs(f)) && Math.abs(a - T) <= i * Math.max(1, Math.abs(a), Math.abs(T));
}
function qn(s, e) {
...
class dt extends Float32Array {
   ...
   */
  constructor(e, i) {
    super(2), typeof e == "number" && typeof i == "number" ? ks(this, e, i) : this.copy(e);
  }
  /**
  ...
  eq(e, i = Wt) {
    ...
    $(n) && (n = e.width);
    let r = Y(e[1]) ? e[1] : e.y;
    return $(r) && (r = e.height), zn(this, [n, r], i);
  }
  get x() {
    return this[0];
  }
...
const zi = (s, e, i, n, r) => [
  ...
  let h;
  if (i && n)
    h = Zn(s, e.x, e.y, i.x, i.y, n.x, n.y, r.x, r.y);
  else if (i || n) {
    const o = i || n;
    h = Kn(s, e.x, e.y, o.x, o.y, r.x, r.y);
  } else
    h = zi(s, e.x, e.y, r.x, r.y);
...
const { abs: Xt, cos: lt, sin: Pt, acos: jn, atan2: vt, sqrt: Nt, pow: ot } = Math;
function Yt(s) {
  return s < 0 ? -ot(-s, 1 / 3) : ot(s, 1 / 3);
}
const $i = Math.PI, es = 2 * $i, Ot = $i / 2, Qn = 1e-6, ds = Number.MAX_SAFE_INTEGER || 9007199254740991, Ns = Number.MIN_SAFE_INTEGER || -9007199254740991, Jn = { x: 0, y: 0, z: 0 }, x = {
  ...
  between: function(s, e, i) {
    return e <= s && s <= i || x.approximately(s, e) || x.approximately(s, i);
  },
  approximately: function(s, e, i) {
    return Xt(s - e) <= (i || Qn);
  },
  length: function(s) {
    const i = x.Tvalues.length;
    let n = 0;
    for (let r = 0, h; r < i; r++)
      h = 0.5 * x.Tvalues[r] + 0.5, n += x.Cvalues[r] * x.arcfn(h, s);
    return 0.5 * n;
  },
  ...
  pointsToString: function(s) {
    return "[" + s.map(x.pointToString).join(", ") + "]";
  },
  copy: function(s) {
  ...
  lli4: function(s, e, i, n) {
    ...
    return x.lli8(r, h, o, c, a, _, u, E);
  },
  lli: function(s, e) {
    return x.lli4(s, s.c, e, e.c);
  },
  ...
  makeshape: function(s, e, i) {
    const n = e.points.length, r = s.points.length, h = x.makeline(e.points[n - 1], s.points[0]), o = x.makeline(s.points[r - 1], e.points[0]), c = {
      startcap: h,
      forward: s,
      back: e,
      endcap: o,
      bbox: x.findbbox([h, s, e, o])
    };
    return c.intersections = function(a) {
      return x.shapeintersections(
        c,
        c.bbox,
        a,
        a.bbox,
  ...
  align: function(s, e) {
    const i = e.p1.x, n = e.p1.y, r = -vt(e.p2.y - n, e.p2.x - i), h = function(o) {
      return {
  ...
  roots: function(s, e) {
    ...
    const i = s.length - 1, n = x.align(s, e), r = function(C) {
      return 0 <= C && C <= 1;
    };
    if (i === 2) {
      const C = n[0].y, M = n[1].y, P = n[2].y, p = C - 2 * M + P;
      if (p !== 0) {
        const D = -Nt(M * M - C * P), G = -C + M, w = -(D + G) / p, b = -(-D + G) / p;
        return [w, b].filter(r);
      } else if (M !== P && p === 0)
    ...
    if (x.approximately(_, 0)) {
      if (x.approximately(u, 0))
        return x.approximately(E, 0) ? [] : [-l / E].filter(r);
      const C = Nt(E * E - 4 * u * l), M = 2 * u;
      return [(C - E) / M, (-E - C) / M].filter(r);
    }
    u /= _, E /= _, l /= _;
    const f = (3 * E - u * u) / 3, T = f / 3, N = (2 * u * u * u - 9 * u * E + 27 * l) / 27, d = N / 2, O = d * d + T * T * T;
    let A, g, R, I, S;
    if (O < 0) {
      const C = -f / 3, M = C * C * C, P = Nt(M), p = -N / (2 * P), D = p < -1 ? -1 : p > 1 ? 1 : p, G = jn(D), w = Yt(P), b = 2 * w;
      return R = b * lt(G / 3) - u / 3, I = b * lt((G + es) / 3) - u / 3, S = b * lt((G + 2 * es) / 3) - u / 3, [R, I, S].filter(r);
    } else {
      if (O === 0)
        return A = d < 0 ? Yt(-d) : -Yt(d), R = 2 * A - u / 3, I = -A - u / 3, [R, I].filter(r);
      {
        const C = Nt(O);
        return A = Yt(-d + C), g = Yt(d + C), [A - g - u / 3].filter(r);
      }
    }
  },
  droots: function(s) {
  ...
  curvature: function(s, e, i, n, r) {
    let h, o, c, a, _ = 0, u = 0;
    const E = x.compute(s, e), l = x.compute(s, i), f = E.x * E.x + E.y * E.y;
    if (n ? (h = Nt(
      ot(E.y * l.z - l.y * E.z, 2) + ot(E.z * l.x - l.z * E.x, 2) + ot(E.x * l.y - l.x * E.y, 2)
    ), o = ot(f + E.z * E.z, 3 / 2)) : (h = E.x * l.y - E.y * l.x, o = ot(f, 3 / 2)), h === 0 || o === 0)
      return { k: 0, r: 0 };
    if (_ = h / o, u = o / h, !r) {
      const T = x.curvature(s - 1e-3, e, i, n, !0).k, N = x.curvature(s + 1e-3, e, i, n, !0).k;
      a = (N - _ + (_ - T)) / 2, c = (Xt(N - _) + Xt(_ - T)) / 2;
    }
    return { k: _, r: u, dk: a, adk: c };
  },
  inflections: function(s) {
    if (s.length < 4) return [];
    const e = x.align(s, { p1: s[0], p2: s.slice(-1)[0] }), i = e[2].x * e[1].y, n = e[3].x * e[1].y, r = e[1].x * e[2].y, h = e[3].x * e[2].y, o = 18 * (-3 * i + 2 * n + 3 * r - h), c = 18 * (3 * i - n - 3 * r), a = 18 * (r - i);
    if (x.approximately(o, 0)) {
      if (!x.approximately(c, 0)) {
        let l = -a / c;
        if (0 <= l && l <= 1) return [l];
      }
      return [];
  ...
  bboxoverlap: function(s, e) {
    ...
    for (let r = 0, h, o, c, a; r < n; r++)
      if (h = i[r], o = s[h].mid, c = e[h].mid, a = (s[h].size + e[h].size) / 2, Xt(o - c) >= a) return !1;
    return !0;
  },
  ...
  pairiteration: function(s, e, i) {
    ...
    _ = _.filter(function(E) {
      return x.bboxoverlap(E.left.bbox(), E.right.bbox());
    });
    let u = [];
    return _.length === 0 || (_.forEach(function(E) {
      u = u.concat(
        x.pairiteration(E.left, E.right, o)
      );
  ...
  getccenter: function(s, e, i) {
    const n = e.x - s.x, r = e.y - s.y, h = i.x - e.x, o = i.y - e.y, c = n * lt(Ot) - r * Pt(Ot), a = n * Pt(Ot) + r * lt(Ot), _ = h * lt(Ot) - o * Pt(Ot), u = h * Pt(Ot) + o * lt(Ot), E = (s.x + e.x) / 2, l = (s.y + e.y) / 2, f = (e.x + i.x) / 2, T = (e.y + i.y) / 2, N = E + c, d = l + a, O = f + _, A = T + u, g = x.lli8(E, l, N, d, f, T, O, A), R = x.dist(g, s);
    let I = vt(s.y - g.y, s.x - g.x), S = vt(e.y - g.y, e.x - g.x), C = vt(i.y - g.y, i.x - g.x), M;
    return I < C ? ((I > S || S > C) && (I += es), I > C && (M = C, C = I, I = M)) : C < S && S < I ? (M = C, C = I, I = M) : C += es, g.s = I, g.e = C, g.r = R, g;
  },
...
class Qt {
  ...
  toString() {
    return "[" + this.curves.map(function(e) {
      return x.pointsToString(e.points);
    }).join(", ") + "]";
  }
  addCurve(e) {
...
const { abs: zt, min: ai, max: _i, cos: tr, sin: sr, acos: er, sqrt: Bt } = Math, ir = Math.PI;
class B {
  constructor(e) {
    ...
    const E = x.align(c, { p1: c[0], p2: c[_] }), l = x.dist(c[0], c[_]);
    this._linear = E.reduce((f, T) => f + zt(T.y), 0) < l / 50, this._lut = [], this._t1 = 0, this._t2 = 1, this.update();
  }
  ...
  static cubicFromPoints(e, i, n, r, h) {
    ...
    typeof h > "u" && (h = x.dist(i, o.C));
    const c = h * (1 - r) / r, a = x.dist(e, n), _ = (n.x - e.x) / a, u = (n.y - e.y) / a, E = h * _, l = h * u, f = c * _, T = c * u, N = { x: i.x - E, y: i.y - l }, d = { x: i.x + f, y: i.y + T }, O = o.A, A = { x: O.x + (N.x - O.x) / (1 - r), y: O.y + (N.y - O.y) / (1 - r) }, g = { x: O.x + (d.x - O.x) / r, y: O.y + (d.y - O.y) / r }, R = { x: e.x + (A.x - e.x) / r, y: e.y + (A.y - e.y) / r }, I = {
      x: n.x + (g.x - n.x) / (1 - r),
      y: n.y + (g.y - n.y) / (1 - r)
    };
  ...
  computedirection() {
    const e = this.points, i = x.angle(e[0], e[this.order], e[1]);
    this.clockwise = i > 0;
  }
  length() {
  ...
  static getABC(e = 2, i, n, r, h = 0.5) {
    const o = x.projectionratio(h, e), c = 1 - o, a = {
      x: o * i.x + c * r.x,
      y: o * i.y + c * r.y
    }, _ = x.abcratio(h, e);
    return { A: {
  ...
  on(e, i) {
    ...
    for (let h = 0, o, c = 0; h < n.length; h++)
      o = n[h], x.dist(o, e) < i && (r.push(o), c += h / n.length);
    return r.length ? t /= r.length : !1;
  }
  project(e) {
    const i = this.getLUT(), n = i.length - 1, r = x.closest(i, e), h = r.mpos, o = (h - 1) / n, c = (h + 1) / n, a = 0.1 / n;
    let _ = r.mdist, u = o, E = u, l;
    _ += 1;
    for (let f; u < c + a; u += a)
      l = this.compute(u), f = x.dist(e, l), f < _ && (_ = f, E = u);
  ...
  compute(e) {
    return this.ratios ? x.computeWithRatios(e, this.points, this.ratios, this._3d) : x.compute(e, this.points, this._3d, this.ratios);
  }
  raise() {
  ...
  derivative(e) {
    return x.compute(e, this.dpoints[0], this._3d);
  }
  dderivative(e) {
    return x.compute(e, this.dpoints[1], this._3d);
  }
  align() {
    let e = this.points;
    return new B(x.align(e, { p1: e[0], p2: e[e.length - 1] }));
  }
  curvature(e) {
    return x.curvature(e, this.dpoints[0], this.dpoints[1], this._3d);
  }
  inflections() {
  ...
  __normal2(e) {
    const i = this.derivative(e), n = Bt(i.x * i.x + i.y * i.y);
    return { t: e, x: -i.y / n, y: i.x / n };
  }
  __normal3(e) {
    const i = this.derivative(e), n = this.derivative(e + 0.01), r = Bt(i.x * i.x + i.y * i.y + i.z * i.z), h = Bt(n.x * n.x + n.y * n.y + n.z * n.z);
    i.x /= r, i.y /= r, i.z /= r, n.x /= h, n.y /= h, n.z /= h;
    const o = {
      x: n.y * i.z - n.z * i.y,
      y: n.z * i.x - n.x * i.z,
      z: n.x * i.y - n.y * i.x
    }, c = Bt(o.x * o.x + o.y * o.y + o.z * o.z);
    o.x /= c, o.y /= c, o.z /= c;
    const a = [
      o.x * o.x,
      o.x * o.y - o.z,
  ...
  hull(e) {
    ...
    for (r[h++] = i[0], r[h++] = i[1], r[h++] = i[2], this.order === 3 && (r[h++] = i[3]); i.length > 1; ) {
      ...
      for (let o = 0, c, a = i.length - 1; o < a; o++)
        c = x.lerp(e, i[o], i[o + 1]), r[h++] = c, n.push(c);
      i = n;
    }
    return r;
  }
  split(e, i) {
    ...
    return r.left._t1 = x.map(0, 0, 1, this._t1, this._t2), r.left._t2 = x.map(e, 0, 1, this._t1, this._t2), r.right._t1 = x.map(e, 0, 1, this._t1, this._t2), r.right._t2 = x.map(1, 0, 1, this._t1, this._t2), i ? (i = x.map(i, e, 1, 0, 1), r.right.split(i).left) : r;
  }
  extrema() {
    const e = {};
    let i = [];
    return this.dims.forEach(
      (function(n) {
        ...
        e[n] = x.droots(h), this.order === 3 && (h = this.dpoints[1].map(r), e[n] = e[n].concat(x.droots(h))), e[n] = e[n].filter(function(o) {
          return o >= 0 && o <= 1;
        }), i = i.concat(e[n].sort(x.numberSort));
      }).bind(this)
    ), e.values = i.sort(x.numberSort).filter(function(n, r) {
  ...
  bbox() {
    ...
    return this.dims.forEach(
      (function(n) {
        i[n] = x.getminmax(this, n, e[n]);
      }).bind(this)
    ), i;
  }
  overlaps(e) {
    const i = this.bbox(), n = e.bbox();
    return x.bboxoverlap(i, n);
  }
  offset(e, i) {
    if (typeof i < "u") {
  ...
  simple() {
    if (this.order === 3) {
      const r = x.angle(this.points[0], this.points[3], this.points[1]), h = x.angle(this.points[0], this.points[3], this.points[2]);
      if (r > 0 && h < 0 || r < 0 && h > 0) return !1;
    }
    const e = this.normal(0), i = this.normal(1);
    let n = e.x * i.x + e.y * i.y;
    return this._3d && (n += e.z * i.z), zt(er(n)) < ir / 3;
  }
  reduce() {
      ...
      for (i = 0, n = 0; n <= 1; )
        for (n = i + r; n <= 1 + r; n += r)
          if (h = _.split(i, n), !h.simple()) {
            if (n -= r, zt(i - n) < r)
              return [];
            h = _.split(i, n), h._t1 = x.map(i, 0, 1, _._t1, _._t2), h._t2 = x.map(n, 0, 1, _._t1, _._t2), c.push(h), i = n;
            break;
          }
      i < 1 && (h = _.split(i, 1), h._t1 = x.map(i, 0, 1, _._t1, _._t2), h._t2 = _._t2, c.push(h));
    }), c;
  }
  translate(e, i, n) {
  ...
  scale(e) {
    ...
    const o = n ? n(0) : e, c = n ? n(1) : e, a = [this.offset(0, 10), this.offset(1, 10)], _ = [], u = x.lli4(a[0], a[0].c, a[1], a[1].c);
    if (!u)
      throw new Error("cannot scale this curve. Try reducing it first.");
    return [0, 1].forEach(function(E) {
      const l = _[E * i] = x.copy(h[E * i]);
      ...
      if (i === 2 && E) return;
      const l = _[E * i], f = this.derivative(E), T = { x: l.x + f.x, y: l.y + f.y };
      _[E + 1] = x.lli4(l, T, u, h[E + 1]);
    }), new B(_));
  }
  outline(e, i, n, r) {
    if (i = i === void 0 ? e : i, this._linear) {
      const I = this.normal(0), S = this.points[0], C = this.points[this.points.length - 1];
      let M, P, p;
      n === void 0 && (n = e, r = i), M = { x: S.x + I.x * e, y: S.y + I.y * e }, p = { x: C.x + I.x * n, y: C.y + I.y * n }, P = { x: (M.x + p.x) / 2, y: (M.y + p.y) / 2 };
      const D = [M, P, p];
      M = { x: S.x - I.x * i, y: S.y - I.y * i }, p = { x: C.x - I.x * r, y: C.y - I.y * r }, P = { x: (M.x + p.x) / 2, y: (M.y + p.y) / 2 };
      const G = [p, P, M], w = x.makeline(G[2], D[0]), b = x.makeline(D[2], G[0]), v = [w, new B(D), b, new B(G)];
      return new Qt(v);
    }
    const h = this.reduce(), o = h.length, c = [];
    let a = [], _, u = 0, E = this.length();
    const l = typeof n < "u" && typeof r < "u";
    function f(I, S, C, M, P) {
      return function(p) {
        const D = M / C, G = (M + P) / C, w = S - I;
        return x.map(p, 0, 1, I + D * w, I + G * w);
      };
    }
    h.forEach(function(I) {
      ...
      l ? (c.push(
        ...
        I.scale(f(-i, -r, E, u, S))
      )) : (c.push(I.scale(e)), a.push(I.scale(-i))), u += S;
    }), a = a.map(function(I) {
      return _ = I.points, _[3] ? I.points = [_[3], _[2], _[1], _[0]] : I.points = [_[2], _[1], _[0]], I;
    }).reverse();
    const T = c[0].points[0], N = c[o - 1].points[c[o - 1].points.length - 1], d = a[o - 1].points[a[o - 1].points.length - 1], O = a[0].points[0], A = x.makeline(d, T), g = x.makeline(N, O), R = [A].concat(c).concat([g]).concat(a);
    return new Qt(R);
  }
  outlineshapes(e, i, n) {
    i = i || e;
  ...
  lineIntersects(e) {
    const i = ai(e.p1.x, e.p2.x), n = ai(e.p1.y, e.p2.y), r = _i(e.p1.x, e.p2.x), h = _i(e.p1.y, e.p2.y);
    return x.roots(this.points, e).filter((o) => {
      var c = this.get(o);
      return x.between(c.x, i, r) && x.between(c.y, n, h);
    });
  }
  selfintersects(e) {
  ...
  _error(e, i, n, r) {
    const h = (r - n) / 4, o = this.get(n + h), c = this.get(r - h), a = x.dist(e, i), _ = x.dist(e, o), u = x.dist(e, c);
    return zt(_ - a) + zt(u - a);
  }
  _iterate(e, i) {
    let n = 0, r = 1, h;
    do {
      h = 0, r = 1;
      let o = this.get(n), c, a, _, u, E = !1, l = !1, f, T = r, N = 1;
      do
        if (l = E, u = _, T = (n + r) / 2, c = this.get(T), a = this.get(r), _ = x.getccenter(o, c, a), _.interval = {
          start: n,
          end: r
          ...
          if (r >= 1) {
            if (_.interval.end = N = 1, u = _, r > 1) {
              ...
              _.e += x.angle({ x: _.x, y: _.y }, O, this.get(1));
            }
            break;
          }
          r = r + (r - n) / 2;
...
class _s extends Float32Array {
   ...
   */
  constructor(e, i, n, r) {
    super(4), typeof e == "number" && typeof i == "number" && typeof n == "number" && typeof r == "number" ? Ws(this, e, i, n, r) : this.copy(e);
  }
  /**
  ...
  copy(e) {
    ...
    $(n) && (n = e.g);
    let r = Y(e[2]) ? e[2] : e.z;
    $(r) && (r = Y(e.b) ? e.b : e.width);
    let h = Y(e[3]) ? e[3] : e.w;
    $(h) && (h = Y(e.a) ? e.a : e.height), ct(i) && ct(n) && ct(r) && ct(h) && Ws(this, i, n, r, h);
  }
  /**
  ...
  eq(e, i = Wt) {
    ...
    $(r) && (r = e.g);
    let h = Y(e[2]) ? e[2] : e.z;
    $(h) && (h = Y(e.b) ? e.b : e.width);
    let o = Y(e[3]) ? e[3] : e.w;
    return $(o) && (o = Y(e.a) ? e.a : e.height), Bn(this, [n, r, h, o], i);
  }
  get x() {
    return this[0];
  }
...
_s.ZERO = new _s(0, 0, 0, 0);
_s.ONE = new _s(1, 1, 1, 1);
var nr = { exports: {} };
(function(s) {
  var e = Object.prototype.hasOwnProperty, i = "~";
  function n() {
  ...
  c.prototype.eventNames = function() {
    ...
    if (!E) return [];
    if (E.fn) return [E.fn];
    for (var l = 0, f = E.length, T = new Array(f); l < f; l++)
      T[l] = E[l].fn;
    return T;
  }, c.prototype.listenerCount = function(_) {
    var u = i ? i + _ : _, E = this._events[u];
    return E ? E.fn ? 1 : E.length : 0;
  }, c.prototype.emit = function(_, u, E, l, f, T) {
    var N = i ? i + _ : _;
    if (!this._events[N]) return !1;
    var d = this._events[N], O = arguments.length, A, g;
    if (d.fn) {
      switch (d.once && this.removeListener(_, d.fn, void 0, !0), O) {
        case 1:
          return d.fn.call(d.context), !0;
        case 2:
          return d.fn.call(d.context, u), !0;
        case 3:
          return d.fn.call(d.context, u, E), !0;
        case 4:
          return d.fn.call(d.context, u, E, l), !0;
        case 5:
          return d.fn.call(d.context, u, E, l, f), !0;
        case 6:
          return d.fn.call(d.context, u, E, l, f, T), !0;
      }
      ...
      var R = d.length, I;
      for (g = 0; g < R; g++)
        switch (d[g].once && this.removeListener(_, d[g].fn, void 0, !0), O) {
          case 1:
            d[g].fn.call(d[g].context);
            break;
          case 2:
            d[g].fn.call(d[g].context, u);
            break;
          case 3:
            d[g].fn.call(d[g].context, u, E);
            break;
          case 4:
            d[g].fn.call(d[g].context, u, E, l);
            break;
          default:
            if (!A) for (I = 1, A = new Array(O - 1); I < O; I++)
              A[I - 1] = arguments[I];
            d[g].fn.apply(d[g].context, A);
        }
    }
    return !0;
    ...
    var T = this._events[f];
    if (T.fn)
      T.fn === u && (!l || T.once) && (!E || T.context === E) && o(this, f);
    else {
      for (var N = 0, d = [], O = T.length; N < O; N++)
        (T[N].fn !== u || l && !T[N].once || E && T[N].context !== E) && d.push(T[N]);
      d.length ? this._events[f] = d.length === 1 ? d[0] : d : o(this, f);
    }
    return this;
...
const rr = ["before", "after", "index", "toIndex", "fromIndex"];
let hr = class {
  constructor(e) {
    let i;
    for (i of rr)
...
class or {
  constructor({ CREATE: e, UPDATE: i, DELETE: n } = {}) {
    this.type = Ht.ENTITY, this.CREATE = new Set(e), this.UPDATE = new Map(i), this.UPDATE.forEach((r, h) => {
      this.UPDATE.set(h, new ms(r));
  ...
  update(e, i, n) {
    this.DELETE.delete(e), this.UPDATE.has(e) || this.UPDATE.set(e, new ms()), this.UPDATE.get(e).update(i, n);
  }
  delete(e) {
    for (const i of e)
...
const Ct = "default", ui = 0, Cs = "-", _r = [
  ...
  if (s === Ct)
    return `${e}`;
  const n = [];
  return s && n.push(s), n.push(e), i && n.push(i), n.join(Cs);
}, ur = () => {
  const s = _r.reduce((e, i) => (e[i] = xs(i, ui), e), {});
  return s[Ct] = `${ui}`, s;
};
class Er {
  constructor() {
    this._counter = ur(), this.suffixKey = ar(4);
  }
  getCurrentCount(e) {
  ...
  _getNumber(e, i) {
    ...
    const n = this._getPrefixKey(e), r = i || this._counter[n], h = isNaN(Number(r)) ? this._counter[Ct] : r, o = n === Ct ? h : r.split(Cs)[1];
    return parseInt(o);
  }
  isInCounter(e, i) {
...
new Er();
const Jt = 1e-5, Z = 1e-12, Os = 112e-18, _t = 1e-8, Et = 1e-7, lr = 1e-5;
new dt();
class Mt extends Float32Array {
  ...
  copy(e) {
    ...
    return ct(i) && ct(n) && ct(r) && ct(h) && ct(o) && ct(c) && Fs(this, i, n, r, h, o, c), this;
  }
  /**
...
L.isOrthogonal = (s, e, i, n) => Math.abs(s * i + e * n) <= Math.sqrt((s * s + e * e) * (i * i + n * n)) * qi;
L.isCollinear = (s, e, i, n) => (
  ...
  Math.abs(s * n - e * i) <= Math.sqrt((s * s + e * e) * (i * i + n * n)) * qi
);
...
L.prototype = {
  ...
  equals(s) {
    ...
    return Math.abs(e - n) <= Ei * Math.max(1, Math.abs(e), Math.abs(n)) && Math.abs(i - r) <= Ei * Math.max(1, Math.abs(i), Math.abs(r));
  },
  /**
   ...
   */
  slide(s) {
    return this.subtract(fr.copy(s).scale(this.dot(s)));
  },
  /**
  ...
  is_zero(s = null) {
    return s ? li(this.x, s) && li(this.y, s) : this.x === 0 && this.y === 0;
  },
  /**
   * @param {Vector2} point
   * @returns {boolean}
...
class Nr {
  ...
  *iter() {
    ...
    for (let r = this.cmdS + 1; r < this.cmdE; r++) {
      ...
      const T = this.path.cornerRadiusOverrides[e], N = this.path.vertices[e++], d = this.path.vertices[e++];
      i = N, n = d, yield new As(
        h,
        a,
        _,
        u,
...
class As {
  ...
  bezier() {
    ...
    if (this.cmd === W.C) {
      const e = this.p0.equals(this.cp0), i = this.p1.equals(this.cp1), n = e ? fi(this.p0, this.cp1) : this.cp0, r = i ? fi(this.p1, this.cp0) : this.cp1;
  ...
  bezierData() {
    if (!this.isCurve) throw new Error("not a curve");
    return Or(this.p0, this.cp0, this.cp1, this.p1);
  }
}
function Or(s, e, i, n, r = 256) {
  const [h, o] = Ar(s, e, i, n, r), c = (u) => Bi(u, s, e, i, n), a = (u) => {
    if (u <= 0) return 0;
    if (u >= o) return 1;
    for (let E = 0; E < r; E++)
      if (h[E] >= u) {
        const l = h[E], f = h[E + 1], T = (u - l) / (f - l);
        return (E + T) / r;
      }
    return 1;
  };
...
function fi(s, e) {
  return e.clone().sub(s).normalize().scale(Tr * 100).add(s);
}
const Ar = (s, e, i, n, r = 256) => {
  const h = new Array(r + 1);
  h[0] = 0;
  let o = 0;
  const c = new L().copy(s);
  for (let a = 1; a <= r; a++) {
    const _ = Bi(a / r, s, e, i, n);
...
class Ir {
  constructor() {
    this._enabled = gr, this._logger = {}, this._reset();
  }
  help() {
...
`);
  ...
  begin(e) {
    ...
    this.metricGroups[i] || (this.metricGroups[i] = {}), this.metricGroups[i][n] || (this.metricGroups[i][n] = {
      ...
      maxDeltaTime: 0,
      minDeltaTime: 1 / 0,
      deltaTimeBuffer: new Array(gs).fill(0),
      useSubTimer: !1
  ...
  _recalculateAvgMinMax(e) {
    e.deltaTimeBuffer[e.frameCounter++ % gs] = e.deltaTime, e.maxDeltaTime = Math.max(e.maxDeltaTime, e.deltaTime), e.minDeltaTime = Math.min(e.minDeltaTime, e.deltaTime), e.avgDeltaTime = e.deltaTimeBuffer.reduce((i, n) => i + n, 0) / gs;
  }
  _reset() {
    this.metricGroups = {
      _: {}
...
const Rr = new Ir();
typeof window < "u" && (window.stats = Rr);
const Ki = new Int8Array(4), Lr = new Int32Array(Ki.buffer, 0, 1), mr = new Float32Array(Ki.buffer, 0, 1), Cr = (s) => (Lr[0] = s, mr[0]), xr = (s) => Cr(s & 4278190079);
function Sr(s, e, i, n) {
...
ut.prototype = {
  ...
  as_hex() {
    return this._rgba || (this._rgba = Array(4)), this._rgba[0] = this.r, this._rgba[1] = this.g, this._rgba[2] = this.b, this._rgba[3] = this.a, Mr(this._rgba);
  },
  as_rgba8() {
    return Sr(this.r, this.g, this.b, this.a);
  },
  /**
   * @param {number[]} [out]
   * @returns {number[]}
...
at.prototype = {
   ...
   */
  expand_n(s, e) {
    return this.clone().expand_to(Ti.set(s, e));
  },
  /**
   * @param {Vector2Like} p_vector
   * @returns {Rect2}
   */
  expand_to(s) {
    const e = Dr.set(this.x, this.y), i = Pr.set(this.x + this.width, this.y + this.height);
   ...
   */
  expand_to_n(s, e) {
    return this.expand_to(Ti.set(s, e));
  },
  /**
   * @param {number} x
   * @param {number} y
    ...
    let r = 0, h = 1, o = 0, c = 0;
    {
      ...
      if (_ < u) {
        if (_ > l || u < E)
          return !1;
        const d = u - _;
        f = _ < E ? (E - _) / d : 0, T = u > l ? (l - _) / d : 1, N = -1;
      } else {
        if (u > l || _ < E)
          return !1;
        const d = u - _;
        f = _ > l ? (l - _) / d : 0, T = u < E ? (E - _) / d : 1, N = 1;
      }
      if (f > r && (r = f, o = 0, c = N), T < h && (h = T), h < r)
        return !1;
    }
    {
      ...
      if (f > r && (r = f, o = 1, c = N), T < h && (h = T), h < r)
        return !1;
    }
...
it.prototype = {
  ...
  get_skew() {
    const s = Gr, e = Ur, i = this.basis_determinant();
    return Math.acos(
   ...
   */
  set_skew(s) {
    const e = Vr, i = this.basis_determinant();
  ...
  xform_rect(s, e = new at()) {
    e.set(0, 0, 0, 0);
    const i = wr.set(this.a * s.width, this.b * s.width), n = pr.set(this.c * s.height, this.d * s.height), r = yr.set(s.x, s.y);
  ...
  xform_inv_rect(s, e = new at()) {
    const i = Hr.set(s.x, s.y), n = Fr.set(s.x, s.y + s.height), r = Wr.set(s.x + s.width, s.y + s.height), h = kr.set(s.x + s.width, s.y);
...
it.IDENTITY = new it();
const wr = new L(), pr = new L(), yr = new L(), br = new L(), Gr = new L(), Ur = new L(), Vr = new L(), Hr = new L(), Fr = new L(), Wr = new L(), kr = new L(), ft = {
  line: 1,
  quadratic: 2,
  serpentine: 3,
  cusp: 4,
...
], Q = Math.abs, di = Math.sqrt, Ni = Math.pow, Yr = Math.log2 || function(s) {
  return Math.log(s) * Math.LOG2E;
}, $t = (s, e, i) => s < e ? e : s > i ? i : s, j = {
  ...
  getNormalizationFactor(...s) {
    const e = Math.max(...s);
    return e && (e < 1e-8 || e > 1e8) ? Ni(2, -Math.round(Yr(e))) : 0;
  },
  /**
  ...
  integrate: function(s, e, i, n) {
    let r = 0;
    const h = Xr[n - 2], o = vr[n - 2], c = (i - e) * 0.5, a = c + e, _ = n + 1 >> 1;
    let u = n & 1 ? o[r++] * s(a) : 0;
    for (; r < _; ) {
      const E = c * h[r];
      u += o[r++] * (s(a + E) + s(a - E));
  ...
  solveQuadratic: function(s, e, i, n, r, h) {
    ...
    if (Q(s) < Z) {
      ...
      if (l >= -112e-18) {
        const f = l < 0 ? 0 : di(l), T = e + (e < 0 ? -f : f);
        T === 0 ? (o = i / s, c = -o) : (o = T / s, c = i / T);
      }
    }
    let a = 0;
    const _ = r == null, u = r - Z, E = h + Z;
    return isFinite(o) && (_ || o > u && o < E) && (n[a++] = _ ? o : $t(o, r, h)), c !== o && isFinite(c) && (_ || c > u && c < E) && (n[a++] = _ ? c : $t(c, r, h)), a;
  },
  /**
  ...
  solveCubic: function(s, e, i, n, r, h, o) {
    ...
    if (Q(s) < Z)
      ...
      f(-(e / s) / 3);
      const d = l / s, O = Ni(Q(d), 1 / 3), A = d < 0 ? -1 : 1, g = -E / s, R = g > 0 ? 1.324717957244746 * Math.max(O, di(g)) : O;
      let I = a - A * R;
      if (I !== a) {
        do
          f(I), I = E === 0 ? a : a - l / E / (1 + Os);
        while (A * I > A * a);
        Q(s) * a * a > Q(n / a) && (u = -n / a, _ = (u - i) / a);
      }
    }
    let T = j.solveQuadratic(s, _, u, r, h, o);
    const N = h == null;
    return isFinite(a) && (T === 0 || T > 0 && a !== r[0] && a !== r[1]) && (N || a > h - Z && a < o + Z) && (r[T++] = N ? a : $t(a, h, o)), T;
  }
}, Oi = Math.min, Ai = Math.max;
function zr(s, e, i) {
  function n(o) {
...
function os(s, e, i, n, r) {
  const h = !e || s === e, o = h ? s : s.concat(e), c = s.length, a = o.length, _ = (O, A, g) => {
    ...
    return R - 1;
  }, u = n ? 1 : 0, E = u + 2, l = n ? 0 : 1, f = l + 2, T = Array(a);
  for (let O = 0; O < a; O++)
    T[O] = O;
  T.sort(function(O, A) {
    return o[O][u] - o[A][u];
  ...
  const N = [], d = Array(c);
  for (let O = 0; O < a; O++) {
    const A = T[O], g = o[A], R = h ? A : A - c, I = A < c, S = h || !I;
    let C = I ? [] : null;
    if (N.length) {
      const M = _(
        N,
      ...
      if (N.splice(0, M), h && r) {
        ...
        for (let D = 0; D < N.length; D++) {
          const G = N[D], w = o[G], b = G < c, v = h || G >= c;
          // eslint-disable-next-line no-mixed-operators
          (r || (I && v || S && b) && P >= w[l] - i && p <= w[f] + i) && (I && v && C.push(h ? G : G - c), S && b && d[G].push(R));
        }
      }
    }
    if (I && (s === e && C.push(A), d[A] = C), N.length) {
...
st.intersect = (s, e, i, n, r, h, o, c, a, _) => {
  ...
  if (!j.isMachineZero(u)) {
    const E = s - r, l = e - h;
    let f = (o * l - c * E) / u;
    const T = (i * l - n * E) / u, N = Z, d = -1e-12, O = 1 + N;
    if (_ || d < f && f < O && d < T && T < O)
...
st.getSignedDistance = (s, e, i, n, r, h, o) => (o || (i -= s, n -= e), i === 0 ? n > 0 ? r - s : s - r : n === 0 ? i < 0 ? h - e : e - h : ((r - s) * n - (h - e) * i) / (n > i ? n * gi(1 + i * i / (n * n)) : i * gi(1 + n * n / (i * i))));
st.getDistance = (s, e, i, n, r, h, o) => Qi(st.getSignedDistance(s, e, i, n, r, h, o));
st.prototype = {
  constructor: st,
  /**
   * @param {number} p0x
   ...
   */
  getDistance(s) {
    return Qi(this.getSignedDistance(s));
  },
  /**
   * @param {Vector2} point
   */
...
const Qi = Math.abs, gi = Math.sqrt, wt = {
  None: 0,
  Loop: 1,
  DoubleInflection: 2
};
...
function Br(s, e, i, n, r, h, o, c) {
  const a = Math.max(Math.ceil(Math.log2((i - e) / n)) - 1, 0), _ = r + a;
  let u = n * Math.exp(_ * Math.LN2);
  for (; i - e > 2 * n; ) {
    const E = 0.5 * (e + i), l = u - 0.5 * (i - e), f = (c * e - o * i) / (c - o), T = E - f, N = h * (i - e) * (i - e), d = N <= Math.abs(E - f) ? f + us(N, T) : E, O = Math.abs(d - E) <= l ? d : E - us(l, T), A = s(O);
    if (A > 0)
      i = O, c = A;
    else if (A < 0)
      e = O, o = A;
...
function qr(s, e, i, n) {
  ...
  if (u < 0) {
    const l = pt(-0.25 * u), f = -0.5 * E;
    return [Ri(f + l) + Ri(f - l) - r];
  } else if (u == 0) {
    const l = us(pt(-c), E);
    return [l - r, -2 * l - r];
  } else {
    const l = jr(pt(u), -E) / 3, f = Zr(l), T = Kr(l) * pt(3), N = 0.5 * (-f + T), d = 0.5 * (-f - T), O = 2 * pt(-c);
    return [O * f - r, O * N - r, O * d - r];
  }
}
function Ss(s, e) {
  const i = st.getDistance, n = _t, r = Et;
  let h = m.isStraight(s), o = m.isStraight(e), c = h && o;
  const a = Ii(s) < Ii(e), _ = a ? e : s, u = a ? s : e, E = _[0], l = _[1], f = _[6] - E, T = _[7] - l;
  if (i(E, l, f, T, u[0], u[1], !0) < r && i(E, l, f, T, u[6], u[7], !0) < r)
    !c && i(E, l, f, T, _[2], _[3], !0) < r && i(E, l, f, T, _[4], _[5], !0) < r && i(E, l, f, T, u[2], u[3], !0) < r && i(E, l, f, T, u[4], u[5], !0) < r && (h = !0, o = !0, c = !0);
  else if (c)
    return null;
  if (h ^ o)
    return null;
  const N = [s, e];
  let d = [];
  for (let O = 0; O < 4 && d.length < 2; O++) {
    const A = O & 1, g = A ^ 1, R = O >> 1, I = m.getTimeOf(
      N[A],
      new L(
        N[g][R ? 6 : 0],
        N[g][R ? 7 : 1]
    ...
    if (I != null) {
      const S = A ? [R, I] : [I, R];
      // eslint-disable-next-line no-mixed-operators
      (!d.length || // eslint-disable-next-line no-mixed-operators
      Lt(S[0] - d[0][0]) > n && Lt(S[1] - d[0][1]) > n) && d.push(S);
    }
    if (O > 2 && !d.length)
      break;
  }
  if (d.length !== 2)
    ...
    const O = m.getPart(s, d[0][0], d[1][0]), A = m.getPart(e, d[0][1], d[1][1]);
    (Lt(A[2] - O[2]) > r || Lt(A[3] - O[3]) > r || Lt(A[4] - O[4]) > r || Lt(A[5] - O[5]) > r) && (d = null);
  }
  return d;
}
function Ii(s) {
...
const Lt = Math.abs, pt = Math.sqrt, Kr = Math.sin, Zr = Math.cos, jr = Math.atan2, Ri = Math.cbrt, xt = {
...
y.prototype = {
  ...
  clone() {
    return new y().initWithPoints(this._point, this._handleIn, this._handleOut);
  },
  remove() {
...
Es.prototype = {
  ...
  // eslint-disable-next-line no-unused-vars
  nearest(s, e) {
    const i = this.p1.clone().sub(this.p0), n = this.p1.clone().scale(-2).add(this.p0).add(this.p2), r = this.p0.clone().sub(s), h = r.dot(i), o = 2 * i.length_squared() + r.dot(n), c = 3 * n.dot(i), a = n.length_squared(), _ = qr(h, o, c, a), u = { r_best: null, t_best: 0 };
    let E = !1;
    for (let l = 0, f = _.length; l < f; l++)
      E |= Qr(this, s, u, _[l]);
    return E && (Ms(s, u, 0, this.p0), Ms(s, u, 1, this.p2)), {
      t: u.t_best,
...
function Qr(s, e, i, n) {
  return n < 0 || n > 1 ? !0 : (Ms(e, i, n, s.eval(n)), !1);
}
...
z.prototype = {
  ...
  toPathData() {
    ...
    function f(N, d) {
      ...
      d[0] = O, d[1] = A, d[2] = N._handleIn.x + O, d[3] = N._handleIn.y + A, d[4] = N._handleOut.x + O, d[5] = N._handleOut.y + A;
    }
    function T(N, d) {
    ...
    for (let N = 0; N < e; N++)
      T(s[N]);
    return this._closed && e > 0 && T(s[0]), this._closed && l.commands.push(5), l;
  },
  /**
  ...
  toSVG(s = !1, e = 5) {
    ...
    function d(O, A) {
      if (N(O, r), o = r[0], c = r[1], h)
        T.push("M" + ht.pair(o, c)), h = !1;
      else if (u = r[2], E = r[3], u === o && E === c && l === a && f === _) {
        if (!A)
          if (s)
            T.push(`L${ht.pair(o, c)}`);
          else {
            const g = o - a, R = c - _;
            T.push(
    ...
    for (let O = 0; O < n; O++)
      d(i[O], !1);
    return this._closed && n > 0 && d(i[0], !0), this._closed && T.push("z"), T.join("");
  },
  toString() {
  ...
  compare(s) {
    ...
    let c = 0, a = 0, _, u;
    for (let T = 0; T < r; T++) {
      const N = i[T].getValues();
      o.push(N);
      const d = Ss(h, N);
      if (d) {
        _ = !T && d[0][0] > 0 ? r - 1 : T, u = d[0][1];
        break;
      }
    }
    const E = _t;
    ...
    for (; h && l; ) {
      ...
      if (T) {
        const N = T[0][0];
        if (nt(N - a) < E) {
          a = T[1][0], a === 1 && (h = ++c < n ? e[c].getValues() : null, a = 0);
          const d = T[0][1];
          if (nt(d - u) < E) {
            if (f || (f = [_, d]), u = T[1][1], u === 1 && (++_ >= r && (_ = 0), l = o[_] || i[_].getValues(), u = 0), !h)
              return f[0] === _ && f[1] === u;
            continue;
          }
        }
  ...
  setClosed(s) {
    if (this._closed != (s = !!s)) {
      if (this._closed = s, this._curves) {
        ...
        this._curves.length = e, s && (this._curves[e - 1] = new m().initWithPathAndSegments(
          this,
          this._segments[e - 1],
          this._segments[0]
        ));
  ...
  getCurves() {
    if (!this._curves) {
      ...
      for (let e = 0; e < s; e++)
        this._curves[e] = new m().initWithPathAndSegments(
          this,
          this._segments[e],
  ...
  _add(s, e) {
    ...
    if (this._curves) {
      ...
      for (let a = o; a < c; a++)
        this._curves.splice(a, 0, new m().initWithPathAndSegments(this, null, null));
   ...
   */
  _getWinding(s, e, i) {
    return Ts(s, this.getCurves(), e, i);
  },
  /**
  ...
  trim(s, e, i = !1) {
    ...
    for (let T = 0; T < n.length; T++) {
      const N = n[T].getLength();
      r.push(N), h += N;
    }
    const o = s * h, c = e * h;
    let a = 0, _ = 0, u = 0, E = 0, l = 0;
    for (let T = 0; T < n.length && (l < o && (a = T, u = o - l), l < c && (_ = T, E = c - l), !(l >= o && l >= c)); T++)
      l += r[T];
    const f = [];
    if (i) {
      const T = [], N = [], d = n[a].getValues(), O = n[_].getValues(), A = m.subdivide(d, m.getTimeAt(d, u))[1], g = m.subdivide(O, m.getTimeAt(O, E))[0];
      T.push(
        new y().initWithPointsN(A[0], A[1], A[0] - A[2], A[1] - A[3], A[2] - A[0], A[3] - A[1]),
        new y().initWithPointsN(A[6], A[7], A[4] - A[6], A[5] - A[7], 0, 0)
      );
      let R = !0;
      for (let I = a + 1; I < n.length; I++)
        R && (n[I]._segment1._handleIn = T.pop()._handleIn, T.push(n[I]._segment1), R = !1), T.push(n[I]._segment2);
      if (this._closed) {
        for (let S = 0; S <= _ - 1; S++)
          R && (n[S]._segment1._handleIn = T.pop()._handleIn, T.push(n[S]._segment1), R = !1), T.push(n[S]._segment2);
        const I = T.pop();
        T.push(
          new y().initWithPointsN(g[0], g[1], I._handleIn.x, I._handleIn.y, g[2] - g[0], g[3] - g[1])
        ), T.push(
          new y().initWithPointsN(g[6], g[7], g[4] - g[6], g[5] - g[7], 0, 0)
        ), f.push(new z().setSegments(T));
      } else {
        let I = !0;
        for (let S = 0; S <= _ - 1; S++)
          I && (N.push(n[S]._segment1), I = !1), N.push(n[S]._segment2);
        if (I)
          N.push(
            new y().initWithPointsN(g[0], g[1], 0, 0, g[2] - g[0], g[3] - g[1])
          );
        else {
          const S = N.pop();
          N.push(
            new y().initWithPointsN(g[0], g[1], S._handleIn.x, S._handleIn.y, g[2] - g[0], g[3] - g[1])
          );
        }
        N.push(
          new y().initWithPointsN(g[6], g[7], g[4] - g[6], g[5] - g[7], g[6] - g[4], g[7] - g[5])
        ), f.push(new z().setSegments(T)), f.push(new z().setSegments(N));
      }
    } else {
      const T = [];
      if (a === _) {
        const N = n[a].getValues(), d = m.getPart(N, m.getTimeAt(N, u), m.getTimeAt(N, E));
        T.push(
          new y().initWithPointsN(d[0], d[1], d[0] - d[2], d[1] - d[3], d[2] - d[0], d[3] - d[1]),
          new y().initWithPointsN(d[6], d[7], d[4] - d[6], d[5] - d[7], 0, 0)
        );
      } else {
        const N = n[a].getValues(), d = n[_].getValues(), O = m.subdivide(N, m.getTimeAt(N, u))[1], A = m.subdivide(d, m.getTimeAt(d, E))[0];
        T.push(
          new y().initWithPointsN(O[0], O[1], O[0] - O[2], O[1] - O[3], O[2] - O[0], O[3] - O[1]),
          new y().initWithPointsN(O[6], O[7], O[4] - O[6], O[5] - O[7], 0, 0)
        );
        let g = !0;
        for (let I = a + 1; I <= _ - 1; I++)
          g && (n[I]._segment1._handleIn = T.pop()._handleIn, T.push(n[I]._segment1), g = !1), T.push(n[I]._segment2);
        const R = T.pop();
        T.push(
          new y().initWithPointsN(A[0], A[1], R._handleIn.x, R._handleIn.y, A[2] - A[0], A[3] - A[1])
        ), T.push(
          new y().initWithPointsN(A[6], A[7], A[4] - A[6], A[5] - A[7], A[6] - A[4], A[7] - A[5])
        );
      }
      f.push(new z().setSegments(T));
    }
  ...
  cubicCurveTo(s, e, i, n, r, h) {
    ...
    o.setHandleOut(new L(s, e).subtract(o._point)), this._add([
      new y().initWithPointsN(r, h, i - r, n - h)
    ]);
  },
  /**
   * @param {number} hx
  ...
  arcTo(s, e, i, n, r, h) {
    ...
    let T = nt(i.width), N = nt(i.height), d = T * T, O = N * N;
    const A = l * l, g = f * f;
    let R = Si(A / d + g / O);
    if (R > 1 && (T *= R, N *= R, d = T * T, O = N * N), R = (d * O - d * g - O * A) / (d * g + O * A), nt(R) < Z && (R = 0), R < 0)
      throw new Error("Cannot create an arc with the given arguments");
    const I = (h === r ? -1 : 1) * Si(R), S = new L(T * f / N, -N * l / T).multiply(I, I).rotate(n).clone().add(u), C = new it().translate(S.x, S.y).rotate_basis(n).scale_basis(T, N), M = new L();
    new it().copy(C).affine_inverse().xform(a, M);
    const P = new L();
    new it().copy(C).affine_inverse().xform(o, P);
    let p = M.angle_to(P) * 180 / Math.PI;
    if (!r && p > 0 ? p -= 360 : r && p < 0 && (p += 360), p) {
      const D = lr, G = nt(p), w = G >= 360 ? 4 : Math.ceil((G - D) / 90), b = p / w, v = b * Math.PI / 360, X = 4 / 3 * Math.sin(v) / (1 + Math.cos(v)), H = [];
      let F = new L();
      for (let V = 0; V <= w; V++) {
        F.copy(o);
        let U = null;
        if (V < w && (U = M.clone().rotate(90 * Math.PI / 180).multiply(X, X), C ? (C.xform(M, F), C.xform(M.clone().add(U), U), U.subtract(F)) : F = S.clone().add(M)), !V)
          c.setHandleOut(U);
        else {
          const q = M.clone().rotate(-90 * Math.PI / 180).multiply(X, X);
          C && (C.xform(M.clone().add(q), q), q.subtract(F)), H.push(new y().initWithPoints(F, q, U));
        }
        M.rotate(b * Math.PI / 180);
      }
      this._add(H);
    }
  }
...
z.makeRectN = (s, e, i, n) => {
  const r = i / 2, h = n / 2;
  return z.createPath([
    new y().initWithPointsN(s - r, e + h, 0, 0, 0, 0),
    new y().initWithPointsN(s - r, e - h, 0, 0, 0, 0),
    new y().initWithPointsN(s + r, e - h, 0, 0, 0, 0),
    new y().initWithPointsN(s + r, e + h, 0, 0, 0, 0)
...
z.makeCircleN = (s, e, i) => {
  ...
  return z.createPath([
    new y().initWithPointsN(s - i, e, 0, r, 0, -r),
    new y().initWithPointsN(s, e - i, -r, 0, r, 0),
    new y().initWithPointsN(s + i, e, 0, -r, 0, r),
    new y().initWithPointsN(s, e + i, r, 0, -r, 0)
  ], !0);
};
z.getBounds = (s, e) => {
  ...
  for (let a = 1, _ = s.length; a < _; a++)
    mi(s[a], n, r, h, o, c);
  return e && mi(i, n, r, h, o, c), new at(h[0], h[1], o[0] - h[0], o[1] - h[1]);
};
z.getHandleBounds = (s, e) => {
  ...
  for (let c = 0, a = s.length; c < a; c++) {
    ...
    for (let u = 0; u < 6; u += 2) {
      const E = i[u], l = i[u + 1], f = E, T = E, N = l, d = l;
      f < n && (n = f), T > r && (r = T), N < h && (h = N), d > o && (o = d);
    }
  }
...
tt.prototype = {
  ...
  removeChildren(s, e) {
    ...
    const i = Ds(this._children, null, s, e - s);
  ...
  getBounds() {
    ...
    let n = Number.MAX_SAFE_INTEGER, r = Number.MIN_SAFE_INTEGER, h = Number.MAX_SAFE_INTEGER, o = Number.MIN_SAFE_INTEGER, c = 0, a = 0, _ = 0, u = 0, E = 0, l = 0, f = 0, T = 0, N = 0, d = 0, O = 0;
    const A = () => {
        ...
        case W.Q:
          {
            ...
            const R = new Es().initN(a, _, l, f, u, E).getBounds();
            n = Math.min(n, R.x), h = Math.min(h, R.y), r = Math.max(r, R.x + R.width), o = Math.max(o, R.y + R.height);
          }
          break;
        case W.C:
          {
            T = i[c++], N = i[c++], d = i[c++], O = i[c++], u = i[c++], E = i[c++];
            const I = new m().initWith4PointsN(a, _, T, N, d, O, u, E).getBounds();
  ...
  _trimIndividually(s, e, i = !1) {
    ...
    for (let T = 0; T < this._children.length; T++) {
      const d = this._children[T].getCurves();
      for (let O = 0; O < d.length; O++) {
        const A = d[O].getLength();
        A > 0 && (h += A, n.push(A), r.push([T, O]));
      }
    }
    if (r.length === 0)
      return this;
    ...
    if (this._children = [], i) {
      const [T, N] = r[a], [d, O] = r[_], A = f[T].getCurves()[N].getValues(), g = f[d].getCurves()[O].getValues(), R = m.subdivide(A, m.getTimeAt(A, u))[1], I = m.subdivide(g, m.getTimeAt(g, E))[0];
      let S = T, C = [];
      C.push(
        new y().initWithPointsN(R[0], R[1], R[0] - R[2], R[1] - R[3], R[2] - R[0], R[3] - R[1]),
        new y().initWithPointsN(R[6], R[7], R[4] - R[6], R[5] - R[7], 0, 0)
      );
      let M = !0;
      for (let p = a + 1; p <= n.length + _ - 1; p++) {
        const [D, G] = r[p % n.length], w = f[D].getCurves()[G];
        S !== D ? (this.addChild(z.createPath(C, !1)), S = D, C = [
          w._segment1
        ]) : M && (w._segment1._handleIn = C.pop()._handleIn, C.push(w._segment1), M = !1), C.push(w._segment2);
      }
      S !== d && (this.addChild(z.createPath(C, !1)), S = d, C = [
        new y().initWithPointsN(I[0], I[1], 0, 0, I[2] - I[0], I[3] - I[1])
      ]);
      const P = C.pop();
      C.push(
        new y().initWithPointsN(I[0], I[1], P._handleIn.x, P._handleIn.y, I[2] - I[0], I[3] - I[1])
      ), C.push(
        new y().initWithPointsN(I[6], I[7], I[4] - I[6], I[5] - I[7], I[6] - I[4], I[7] - I[5])
      ), this.addChild(z.createPath(C, !1));
    } else if (a === _) {
      const [T, N] = r[a], d = f[T].getCurves()[N].getValues(), O = m.getPart(d, m.getTimeAt(d, u), m.getTimeAt(d, E));
      this.addChild(z.createPath([
        new y().initWithPointsN(O[0], O[1], 0, 0, O[2] - O[0], O[3] - O[1]),
        new y().initWithPointsN(O[6], O[7], O[4] - O[6], O[5] - O[7], 0, 0)
      ], !1));
    } else {
      const [T, N] = r[a], [d, O] = r[_], A = f[T].getCurves()[N].getValues(), g = f[d].getCurves()[O].getValues(), R = m.subdivide(A, m.getTimeAt(A, u))[1], I = m.subdivide(g, m.getTimeAt(g, E))[0];
      let S = T, C = [];
      C.push(
        new y().initWithPointsN(R[0], R[1], A[0] - A[2], A[1] - A[3], R[2] - R[0], R[3] - R[1]),
        new y().initWithPointsN(R[6], R[7], R[4] - R[6], R[5] - R[7], 0, 0)
      );
      let M = !0;
      for (let p = a + 1; p < _; p++) {
  ...
  moveTo(s, e) {
    return this.addChild(
      z.createPath([
        new y().initWithPointsN(s, e, 0, 0, 0, 0)
      ]),
      !1
    );
  },
...
tt.createFromSVG = (s) => {
  ...
  for (let E = 0, l = i && i.length; E < l; E++) {
    const f = i[E], T = f[0], N = T.toLowerCase();
    n = f.match(/[+-]?(?:\d*\.\d+|\d+\.?)(?:[eE][+-]?\d+)?/g);
    const d = n && n.length;
    switch (r = T === N, h === "z" && !/[mz]/.test(N) && e.moveTo(c.x, c.y), N) {
      case "m":
      case "l":
        let O = N === "m";
        for (let g = 0; g < d; g += 2)
...
tt.trimMultiple = (s, e, i, n) => {
  ...
  const a = [];
  for (let d = 0; d < n.length; d++)
    a.push(n[d].getLength()), c += a[d];
  const _ = r * c, u = h * c;
  let E = 0, l = 0, f = 0, T = 0, N = 0;
  for (let d = 0; d < n.length && (N < _ && (E = d, f = _ - N), N < u && (l = d, T = u - N), !(N >= _ && N >= u)); d++)
    N += a[d];
  return E === l ? a.map((d, O) => O !== E ? o ? n[O].clone() : new tt() : n[O].clone()._trimIndividually(f / d, T / d, o)) : a.map((d, O) => (o ? O > l && O < E : O < E || O > l) ? new tt() : O === E ? n[O].clone()._trimIndividually(f / d, 1) : O === l ? n[O].clone()._trimIndividually(0, T / d) : n[O]);
};
function rt() {
...
rt.prototype = {
  ...
  isCrossing() {
    ...
    if (e > r && (c = c.getNext()), i > r && (_ = _.getNext()), !a || !c || !u || !_)
      return !1;
    const E = [];
    h || (is(E, a, !0), is(E, c, !1)), o || (is(E, u, !0), is(E, _, !1));
    const l = this.getPoint(), f = Math.min.apply(Math, E), T = h ? c.getTangentAtTime(e) : (S = c.getPointAt(f)) == null ? void 0 : S.clone().subtract(l), N = h ? T == null ? void 0 : T.clone().negate() : (C = a.getPointAt(-f)) == null ? void 0 : C.clone().subtract(l), d = o ? _.getTangentAtTime(i) : (M = _.getPointAt(f)) == null ? void 0 : M.clone().subtract(l), O = o ? d == null ? void 0 : d.clone().negate() : (P = u.getPointAt(-f)) == null ? void 0 : P.clone().subtract(l), A = (N == null ? void 0 : N.angle()) * 180 / Math.PI, g = (T == null ? void 0 : T.angle()) * 180 / Math.PI, R = (O == null ? void 0 : O.angle()) * 180 / Math.PI, I = (d == null ? void 0 : d.angle()) * 180 / Math.PI;
...
rt.insert = (s, e, i) => {
  ...
  for (; r <= h; ) {
    const o = r + h >>> 1, c = s[o];
    let a = null;
    if (i && (a = e.equals(c) ? c : Li(s, e, n, o, -1) || Li(s, e, n, o, 1)))
...
function is(s, e, i) {
  const n = e.getValues(), r = m.classify(n).roots || m.getPeaks(n), h = r.length, o = m.getLength(
    n,
    i && h ? r[h - 1] : 0,
    !i && h ? r[0] : 1
  );
...
function tn(s, e, i) {
  const n = Is(i);
  let [r, h] = [s, e];
  r > h && ([r, h] = [h, r]), r = Ci(r), h = Ci(h), r = Math.round((r + n) * 1e4) * 1e-4, h = Math.round((h + n) * 1e4) * 1e-4;
  let o = !1;
  return r > 1 && (r = Is(r), o = !o), h > 1 && (h = Is(h), o = !o), [r, h, o];
}
function Ci(s) {
  return Jr(0, 1, s);
}
...
function Ps(s) {
  ...
  return e ? (Number.isFinite(i) && Ds(e._children, null, i, 1), s._parent = null, !0) : !1;
}
function Us(s) {
  if (s._children) {
    const e = new tt();
    for (let i = 0, n = s._children.length; i < n; i++)
      e.addChild(Us(s._children[i]), !0);
...
function en(s, e, i, n) {
  const r = s === e || !e;
  return r || s.getBounds().intersects(e.getBounds(), Z) ? m.getIntersections(
    s.getCurves(),
    !r && e.getCurves(),
    i,
    n
...
const nn = (s) => {
  ...
  if (h = rt.expand(h), n) {
    ...
    for (let u = _.length - 1; u >= 0; u--) {
      const E = _[u], l = E._path, f = E._segment, T = f.getPrevious(), N = f.getNext();
      xi(T, l) && xi(N, l) && (f.remove(), T._handleOut.set(0, 0), N._handleIn.set(0, 0), T._changed(T._handleOut), N._changed(N._handleIn), T !== f && !T.getCurve().hasLength() && (N._handleIn.set(T._handleIn.x, T._handleIn.y), N._changed(N._handleIn), T.remove()));
    }
  }
  r && (ws(
    h,
    n && ((_) => {
      const u = _.getCurve(), E = _.getSegment(), l = _._intersection, f = l._curve, T = l._segment;
      if (u && f && u._path && f._path)
        return !0;
      E && (E._intersection = null), T && (T._intersection = null);
    }),
    o
  ), o && on(o), i = cn(
    sn(
...
function hn(s) {
  ...
  if (!s.contains(i)) {
    ...
    for (let c = 0, a = n.length; c < a; c++) {
      ...
      if (r >= Zt(u, E, l, f) && r <= yt(u, E, l, f)) {
        const T = m.getMonoCurves(_);
        for (let N = 0, d = T.length; N < d; N++) {
          const O = T[N], A = O[1], g = O[7];
          if (A !== g && (r >= A && r <= g || r >= g && r <= A)) {
            const R = r === A ? O[0] : r === g ? O[6] : m.solveCubic(O, 1, r, o, 0, 1) === 1 ? m.getPoint(O, o[0]).x : (O[0] + O[6]) / 2;
            h.push(R);
          }
        }
      }
...
const Zt = Math.min, yt = Math.max, nt = Math.abs, Si = Math.sqrt, th = {
  [J.UNION]: { 1: !0, 2: !0 },
  [J.INTERSECT]: { 2: !0 },
  [J.SUBTRACT]: { 1: !0 },
...
function ws(s, e, i) {
  ...
  for (let l = s.length - 1; l >= 0; l--) {
    const f = s[l];
    let T = f._time;
    const N = T, d = e && !e(f), O = f._curve;
    let A;
    if (O && (O !== u ? (o = !O.hasHandles() || a && a[wi(O)], _ = [], E = null, u = O) : E >= r && (T /= E)), d) {
      _ && _.push(f);
      continue;
    } else e && n.unshift(f);
    if (E = N, T < r)
...
function Ts(s, e, i, n, r) {
  const h = Array.isArray(e) ? e : e[i ? "hor" : "ver"], o = i ? 1 : 0, c = o ^ 1, a = [s.x, s.y], _ = a[o], u = a[c], E = 1e-9, l = 1e-6, f = _ - E, T = _ + E;
  let N = 0, d = 0, O = 0, A = 0, g = !1, R = !1, I = 1;
  const S = [];
  let C, M;
  function P(D) {
    const G = D[c + 0], w = D[c + 6];
    if (u < Zt(G, w) || u > yt(G, w))
      return;
    const b = D[o + 0], v = D[o + 2], X = D[o + 4], H = D[o + 6];
    if (G === w) {
      (b < T && H > f || H < T && b > f) && (g = !0);
      return;
    }
    const F = u === G ? 0 : u === w || f > yt(b, v, X, H) || T < Zt(b, v, X, H) ? 1 : m.solveCubic(D, c, u, S, 0, 1) > 0 ? S[0] : 1, V = F === 0 ? b : F === 1 ? H : m.getPoint(D, F)[i ? "y" : "x"], U = G > w ? 1 : -1, q = C[c] > C[c + 6] ? 1 : -1, K = C[o + 6];
    return u !== G ? (V < f ? O += U : V > T ? A += U : g = !0, V > _ - l && V < _ + l && (I /= 2)) : (U !== q ? b < f ? O += U : b > T && (A += U) : b !== K && (K < T && V > T ? (A += U, g = !0) : K > f && V < f && (O += U, g = !0)), I /= 4), C = D, !r && V > f && V < T && m.getTangent(D, F)[i ? "x" : "y"] === 0 && Ts(s, e, !i, n, !0);
  }
  function p(D) {
    const G = D[c + 0], w = D[c + 2], b = D[c + 4], v = D[c + 6];
    if (u <= yt(G, w, b, v) && u >= Zt(G, w, b, v)) {
      const X = D[o + 0], H = D[o + 2], F = D[o + 4], V = D[o + 6], U = f > yt(X, H, F, V) || T < Zt(X, H, F, V) ? [D] : m.getMonoCurves(D, i);
      let q;
      for (let K = 0, Rt = U.length; K < Rt; K++)
        if (q = P(U[K]), q)
          return q;
    }
  }
  for (let D = 0, G = h.length; D < G; D++) {
    const w = h[D], b = w._path, v = w.getValues();
    let X;
    if ((!D || h[D - 1]._path !== b) && (C = null, b._closed || (M = m.getValues(
      b.getLastCurve().getSegment2(),
      w.getSegment1(),
      !n
    ), M[c] !== M[c + 6] && (C = M)), !C)) {
      C = v;
      let H = b.getLastCurve();
      for (; H && H !== w; ) {
        const F = H.getValues();
        if (F[c] !== F[c + 6]) {
          C = F;
    ...
    if (X = p(v), X)
      return X;
    if (D + 1 === G || h[D + 1]._path !== b) {
      if (M && (X = p(M)))
        return X;
      g && !O && !A && (O = b.isClockwise(n) ^ i ? 1 : -1, A = O), N += O, d += A, O = 0, A = 0, g && (R = !0, g = !1), M = null;
    }
  }
  return N = nt(N), d = nt(d), {
    winding: yt(N, d),
    windingL: N,
    windingR: d,
    quality: I,
...
function yi(s, e, i, n, r) {
  ...
  for (let l = 0; l < _.length && a.quality < 0.5; l++) {
    ...
    for (let T = 0, N = h.length; T < N; T++) {
      const d = h[T], O = d.length;
      if (f <= O) {
        const A = d.curve, g = A._path, R = g._parent, I = R instanceof tt ? R : g, S = j.clamp(A.getTimeAt(f), u, E), C = A.getPointAtTime(S), M = nt(A.getTangentAtTime(S).y) < Math.SQRT1_2;
        let P = null;
        if (r[J.SUBTRACT - 10] && i) {
          const D = (I === e ? i : e)._getWinding(C, M, !0);
...
function cn(s, e) {
  ...
  for (let r = 0, h = s.length; r < h; r++) {
    let o = s[r], c = Ut(o, e), a = null, _ = !1, u = !0;
    const E = [];
    let l, f, T;
    if (c && o._path._overlapsOnly) {
      const N = o._path, d = o._intersection._segment._path;
      N.compare(d) && (N.getArea() && i.push(N.clone(!1)), bi(N), bi(d), c = !1);
    }
    for (; c; ) {
      const N = !a, d = sh(o, N, n, e), O = d.shift();
      _ = !N && (ls(o, n) || ls(O, n));
      const A = !_ && O;
      ...
      if (A && l && (E.push(l), l = null), l || (A && d.push(o), l = {
        ...
        f.length = 0;
        do
          o = l && l.crossings.shift(), (!o || !o._path) && (o = null, l = E.pop(), l && (f = l.visited, T = l.handleIn));
        while (l && !Ut(o, e));
        if (!o)
          break;
      }
      const g = o.getNext();
      a.add(
        new y().initWithPoints(
          o._point,
          T,
          g && o._handleOut
        )
      ), o._visited = !0, f.push(o), o = g || o._path.getFirstSegment(), T = g && g._handleIn;
    }
    _ && (u && (a.getFirstSegment().setHandleIn(T), a.setClosed(u)), a.getArea() !== 0 && i.push(a));
  }
  return i;
}
function Ut(s, e) {
...
function Gi(s, e, i, n, r, h, o) {
  for (; s && s !== e; ) {
    ...
    if (a) {
      ...
      c !== i && (ls(c, h) || ls(_, h) || _ && Ut(c, o) && (Ut(_, o) || u && Ut(u._segment, o))) && n.push(c), r && h.push(c);
    }
    s = s._next;
  }
}
function an(s, e, i) {
  const n = s && s.length;
  if (n) {
    const r = sn(s, function(a, _) {
      this[a._id] = {
        container: null,
        winding: a.isClockwise() ? 1 : -1,
        index: _
      };
    }, {}), h = s.slice().sort((a, _) => nt(_.getArea()) - nt(a.getArea())), o = h[0], c = zr(
      h,
      null,
      Et
    );
      ...
      if (l) {
        ...
        for (let T = l.length - 1; T >= 0; T--)
          if (l[T] < a) {
            ...
            if (N.contains(f)) {
              const d = r[N._id];
              E = d.winding, u.winding += E, u.container = d.exclude ? d.container : N;
              break;
            }
          }
      }
...
m.prototype = {
  ...
  initWithSegments(s, e) {
    return this._segment1 = new y().copy(s), this._segment2 = new y().copy(e), this;
  },
  /**
   * @param {BezierPath} path
   * @param {Segment} seg1
  ...
  initWith4Points(s, e, i, n) {
    return this._segment1 = new y().initWithPointsN(
      s.x,
      s.y,
      0,
      0,
      e.x - s.x,
      e.y - s.y
    ), this._segment2 = new y().initWithPointsN(
      n.x,
      n.y,
      i.x - n.x,
      i.y - n.y,
  ...
  initWithPointsAndHandles(s, e, i, n) {
    return this._segment1 = new y().initWithPoints(s, null, e), this._segment2 = new y().initWithPoints(n, i, null), this;
  },
  /**
  ...
  initWith4PointsN(s, e, i, n, r, h, o, c) {
    return this._segment1 = new y().initWithPointsN(s, e, 0, 0, i - s, n - e), this._segment2 = new y().initWithPointsN(o, c, r - o, h - c, 0, 0), this;
  },
  /**
  ...
  initWithPointsAndHandlesN(s, e, i, n, r, h, o, c) {
    return this._segment1 = new y().initWithPointsN(s, e, 0, 0, i, n), this._segment2 = new y().initWithPointsN(o, c, r, h, 0, 0), this;
  },
  /**
  ...
  detectCusp(s) {
    ...
    if (u * E > 0 && u * l < 0 && u * f < 0) {
      const T = this.deriv(), N = T.nearest(L.ZERO, 1e-9), d = T.eval(N.t), O = T.deriv().eval(N.t), A = d.cross(O);
      if (bs(N.distance_sq, 3) < bs(A * s, 2)) {
  ...
  invArclen(s, e) {
    ...
    return Br((o) => fs(m.getPart(r, 0, o), e, 0) - s, 0, 1, n, 1, 2, -s, i - s);
  },
  clone() {
    return new m().initWithSegments(this._segment1.clone(), this._segment2.clone());
  },
  remove() {
    let s = !1;
    if (this._path) {
  ...
  divideAtTime(s, e) {
    ...
    let r = null;
    if (s >= i && s <= n) {
      const h = m.subdivide(this.getValues(), s), o = h[0], c = h[1], a = e || this.hasHandles(), _ = this._segment1, u = this._segment2, E = this._path;
      a && (_._handleOut.set(o[2] - o[0], o[3] - o[1]), u._handleIn.set(c[4] - c[6], c[5] - c[7]), _._changed(_._handleOut), u._changed(u._handleIn));
      const l = o[6], f = o[7], T = new y().initWithPoints(
        new L(l, f),
        a && new L(o[4] - l, o[5] - f),
        a && new L(c[2] - l, c[3] - f)
      );
      E ? (E.insert(_._index + 1, T), r = this.getNext()) : (this._segment2 = T, this._changed(), r = new m().initWithSegments(T, u));
    }
    return r;
  },
  /**
  ...
  getLength() {
    return this._length == null && (this._length = m.getLength(this.getValues(), 0, 1)), this._length;
  },
  getSegment1() {
   ...
   */
  getPartLength(s, e) {
    return m.getLength(this.getValues(), s, e);
  },
  /**
   ...
   */
  getTimeOf(s) {
    return m.getTimeOf(this.getValues(), s);
  },
  /**
   ...
   */
  getPointAtTime(s) {
    return m.getPoint(this.getValues(), s);
  },
  /**
   ...
   */
  getTangentAtTime(s) {
    return m.getTangent(this.getValues(), s);
  },
  /**
   * @param {number} location
   * @param {boolean} _isTime
   ...
   */
  getTimeAt(s, e) {
    return m.getTimeAt(this.getValues(), s, e);
  },
  /**
   * @param {CubicBez} curve
   */
  getIntersections(s) {
    ...
    return i ? ln(e, i, this, s, []) : En(e, this, []);
  },
  /**
   * Checks if this curve has any curve handles set.
   */
  hasHandles() {
    return !this._segment1._handleOut.is_zero(Jt) || !this._segment2._handleIn.is_zero(Jt);
  },
  /**
  ...
  isStraight() {
    return m.isStraight(this.getValues(), Et);
  },
  getValues() {
    return m.getValues(this._segment1, this._segment2);
  },
  getBounds() {
    if (this._bounds == null) {
      const s = this.getValues();
      this._bounds = m.getBounds(s);
    }
    return this._bounds;
  },
  /**
...
m.getLength = (s, e = 0, i = 1, n) => {
  if (m.isStraight(s)) {
    let r = s;
    i < 1 && (r = m.subdivide(r, i)[0], e /= i), e > 0 && (r = m.subdivide(r, e)[1]);
    const h = r[6] - r[0], o = r[7] - r[1];
    return It(h * h + o * o);
  }
  return j.integrate(n || fn(s), e, i, Tn(e, i));
};
m.getPart = (s, e, i) => {
  let n = s, r = e, h = i;
  const o = r > h;
  ...
  return r > 0 && (n = m.subdivide(n, r)[1]), h < 1 && (n = m.subdivide(n, (h - r) / (1 - r))[0]), o ? [n[6], n[7], n[4], n[5], n[2], n[3], n[0], n[1]] : n;
};
m.getPoint = (s, e) => kt(s, e, 0, !1);
m.getTangent = (s, e) => kt(s, e, 1, !0);
m.getWeightedTangent = (s, e) => kt(s, e, 1, !1);
m.getNormal = (s, e) => kt(s, e, 2, !0);
m.getWeightedNormal = (s, e) => kt(s, e, 2, !1);
m.getCurvature = (s, e) => kt(s, e, 3, !1).x;
m.getTimeOf = (s, e) => {
  const i = new L(s[0], s[1]), n = new L(s[6], s[7]), r = Z, h = Et;
  if ((e.isClose(i, r) ? 0 : e.isClose(n, r) ? 1 : null) === null) {
    const c = [e.x, e.y], a = [];
    for (let _ = 0; _ < 2; _++) {
      const u = m.solveCubic(s, _, c[_], a, 0, 1);
      for (let E = 0; E < u; E++) {
        const l = a[E];
        if (e.isClose(m.getPoint(s, l), h))
          return l;
      }
    }
  }
...
m.getTimeAt = (s, e, i) => {
  if (i === void 0 && (i = e < 0 ? 1 : 0), e === 0)
    return i;
  const n = Et, r = e > 0, h = r ? i : 0, o = r ? 1 : i, c = fn(s), a = m.getLength(s, h, o, c), _ = ys(e) - a;
  if (ys(_) < n)
    return r ? o : h;
  if (_ > n)
    return null;
...
m.getPeaks = (s) => {
  const e = s[0], i = s[1], n = s[2], r = s[3], h = s[4], o = s[5], c = s[6], a = s[7], _ = -e + 3 * n - 3 * h + c, u = 3 * e - 6 * n + 3 * h, E = -3 * e + 3 * n, l = -i + 3 * r - 3 * o + a, f = 3 * i - 6 * r + 3 * o, T = -3 * i + 3 * r, N = _t, d = 1 - N, O = [];
  return j.solveCubic(
    9 * (_ * _ + l * l),
    9 * (_ * u + f * l),
    2 * (u * u + f * f) + 3 * (E * _ + T * l),
    ...
    return !0;
  {
    ...
    if (_.isCollinear(o) && _.isCollinear(c)) {
      ...
      if (u.getDistance(h.clone().add(o.x, o.y)) < E && u.getDistance(a.clone().add(c.x, c.y)) < E) {
        const l = _.clone().dot(_), f = _.clone().dot(o) / l, T = _.clone().dot(c) / l;
...
m.subdivide = (s, e = 0.5) => {
  const i = s[0], n = s[1], r = s[2], h = s[3], o = s[4], c = s[5], a = s[6], _ = s[7], u = 1 - e, E = u * i + e * r, l = u * n + e * h, f = u * r + e * o, T = u * h + e * c, N = u * o + e * a, d = u * c + e * _, O = u * E + e * f, A = u * l + e * T, g = u * f + e * N, R = u * T + e * d, I = u * O + e * g, S = u * A + e * R;
  return [
    [i, n, E, l, O, A, I, S],
    // left
    [I, S, g, R, N, d, a, _]
...
m.getBounds = (s) => {
  ...
  for (let r = 0; r < 2; r++)
    m._addBounds(s[r], s[r + 2], s[r + 4], s[r + 6], r, e, i, n);
  return new at(e[0], e[1], i[0] - e[0], i[1] - e[1]);
};
m._addBounds = (s, e, i, n, r, h, o, c) => {
  const a = h[r], _ = o[r];
  if (s < a || e < a || i < a || n < a || s > _ || e > _ || i > _ || n > _)
    if (e < s != e < n && i < s != i < n)
      hs(s, r, h, o), hs(n, r, h, o);
    else {
      const u = 3 * (e - i) - s + n, E = 2 * (s + i) - 4 * e, l = e - s, f = j.solveQuadratic(u, E, l, c), T = _t, N = 1 - T;
      hs(n, r, h, o);
      for (let d = 0; d < f; d++) {
        const O = c[d], A = 1 - O;
        T <= O && O <= N && hs(
...
m.getMonoCurves = (s, e) => {
  ...
  if (r >= h == h >= o && h >= o == o >= c || m.isStraight(s))
    i.push(s);
  else {
    const a = 3 * (h - o) - r + c, _ = 2 * (r + o) - 4 * h, u = h - r, E = _t, l = 1 - E, f = [], T = j.solveQuadratic(a, _, u, f, E, l);
    if (!T)
      i.push(s);
    else {
      f.sort();
      let N = f[0], d = m.subdivide(s, N);
      i.push(d[0]), T > 1 && (N = (f[1] - N) / (1 - N), d = m.subdivide(d[1], N), i.push(d[0])), i.push(d[1]);
    }
  }
  return i;
};
m.classify = (s) => {
  ...
  let l = 3 * (h * (r - i) + o * (e - n) + n * i - r * e), f = l - u, T = f - u + _;
  const N = It(T * T + f * f + l * l), d = N === 0 ? 0 : 1 / N, O = j.isZero;
  if (T *= d, f *= d, l *= d, O(T))
    return O(f) ? rs(O(l) ? ft.line : ft.quadratic) : rs(ft.serpentine, l / (3 * f));
  const A = 3 * f * f - 4 * T * l;
  if (O(A))
    return rs(ft.cusp, f / (2 * T));
  const g = A > 0 ? It(A / 3) : It(-A), R = 2 * T;
  return rs(
...
const Gt = Math.min, St = Math.max, ys = Math.abs, rh = Math.ceil, bs = Math.pow, It = Math.sqrt, hh = Math.atan2;
function rs(s, e, i) {
  const n = e !== void 0;
...
function ln(s, e, i, n, r, h) {
  const o = Z;
  if (St(s[0], s[2], s[4], s[6]) + o > Gt(e[0], e[2], e[4], e[6]) && Gt(s[0], s[2], s[4], s[6]) - o < St(e[0], e[2], e[4], e[6]) && St(s[1], s[3], s[5], s[7]) + o > Gt(e[1], e[3], e[5], e[7]) && Gt(s[1], s[3], s[5], s[7]) - o < St(e[1], e[3], e[5], e[7])) {
    const c = Ss(s, e);
    if (c)
      for (let a = 0; a < 2; a++) {
        const _ = c[a];
      ...
      const a = m.isStraight(s), _ = m.isStraight(e), u = a && _, E = a && !_, l = r.length;
      if ((u ? oh : a || _ ? ah : mt)(
        E ? e : s,
        E ? s : e,
        E ? n : i,
        ...
        for (let f = 0; f < 4; f++) {
          const T = f >> 1, N = f & 1, d = T * 6, O = N * 6, A = new L(s[d], s[d + 1]), g = new L(e[O], e[O + 1]);
          A.isClose(g, o) && Ft(
            r,
            h,
            i,
...
function kt(s, e, i, n) {
  ...
  const f = 3 * (o - r), T = 3 * (a - o) - f, N = u - r - f - T, d = 3 * (c - h), O = 3 * (_ - c) - d, A = E - h - d - O;
  let g, R;
  if (i === 0)
    g = e === 0 ? r : e === 1 ? u : ((N * e + T) * e + f) * e + r, R = e === 0 ? h : e === 1 ? E : ((A * e + O) * e + d) * e + h;
  else {
    const I = _t, S = 1 - I;
    if (e < I ? (g = f, R = d) : e > S ? (g = 3 * (u - a), R = 3 * (E - _)) : (g = (3 * N * e + 2 * T) * e + f, R = (3 * A * e + 2 * O) * e + d), n) {
      g === 0 && R === 0 && (e < I || e > S) && (g = a - o, R = _ - c);
      const C = It(g * g + R * R);
      C && (g /= C, R /= C);
    }
    if (i === 3) {
      const C = 6 * N * e + 2 * T, M = 6 * A * e + 2 * O, P = bs(g * g + R * R, 3 / 2);
      g = P === 0 ? 0 : (g * M - R * C) / P, R = 0;
    }
  }
...
function mt(s, e, i, n, r, h, o, c, a, _, u, E, l) {
  if (++a >= 4096 || ++c >= 40)
    return a;
  const f = 1e-9, T = e[0], N = e[1], d = e[6], O = e[7], A = st.getSignedDistance, g = A(T, N, d, O, e[2], e[3]), R = A(T, N, d, O, e[4], e[5]), I = g * R > 0 ? 3 / 4 : 4 / 9, S = I * Gt(0, g, R), C = I * St(0, g, R), M = A(T, N, d, O, s[0], s[1]), P = A(T, N, d, O, s[2], s[3]), p = A(T, N, d, O, s[4], s[5]), D = A(T, N, d, O, s[6], s[7]), G = ch(M, P, p, D), w = G[0], b = G[1];
  let v, X;
  if (g === 0 && R === 0 && M === 0 && P === 0 && p === 0 && D === 0 || (v = Ui(w, b, S, C)) == null || (X = Ui(w.reverse(), b.reverse(), S, C)) == null)
    return a;
...
function Ui(s, e, i, n) {
  return s[0][1] < i ? Vi(s, !0, i) : e[0][1] > n ? Vi(e, !1, n) : s[0][0];
}
function Vi(s, e, i) {
  let n = s[0][0], r = s[0][1];
...
const fn = (s) => {
  const e = s[0], i = s[1], n = s[2], r = s[3], h = s[4], o = s[5], c = s[6], a = s[7], _ = 9 * (n - h) + 3 * (c - e), u = 6 * (e + h) - 12 * n, E = 3 * (n - e), l = 9 * (r - o) + 3 * (a - i), f = 6 * (i + o) - 12 * r, T = 3 * (r - i);
  return function(N) {
    const d = (_ * N + u) * N + E, O = (l * N + f) * N + T;
    return It(d * d + O * O);
  };
}, Tn = (s, e) => St(2, Gt(16, rh(ys(e - s) * 32)));
function ah(s, e, i, n, r, h, o) {
  const c = e[0], a = e[1], _ = e[6], u = e[7], E = _h(s, c, a, _ - c, u - a);
  for (let l = 0, f = E.length; l < f; l++) {
    const T = E[l], N = m.getPoint(s, T), d = m.getTimeOf(e, N);
    d !== null && Ft(
      r,
      h,
      o ? n : i,
...
function _h(s, e, i, n, r) {
  const h = j.isZero;
  if (h(n) && h(r)) {
    const E = m.getTimeOf(s, new L(e, i));
    return E === null ? [] : [E];
  }
  const o = hh(-r, n), c = Math.sin(o), a = Math.cos(o), _ = [], u = [];
  for (let E = 0; E < 8; E += 2) {
  ...
  return m.solveCubic(_, 1, 0, u, 0, 1), u;
}
const uh = [
  0.362683783378362,
  -0.1834346424956498,
...
function fs(s, e, i) {
  const [
    ...
    _,
    u
  ] = s, E = _ - n, l = u - r, f = h - n, T = o - r, N = c - h, d = a - o, O = _ - c, A = u - a, g = Math.hypot(f, T) + Math.hypot(N, d) + Math.hypot(O, A) - Math.hypot(E, l), R = N - f, I = d - T, S = O - N, C = A - d, M = 0.25 * (f + O) + 0.5 * N, P = 0.25 * (T + A) + 0.5 * d, p = 0.5 * (S + R), D = 0.5 * (C + I), G = 0.25 * (S - R), w = 0.25 * (C - I), b = uh;
  let v = 0;
  for (let V = 0; V < b.length; V += 2) {
    const U = b[V + 1], q = M + p * U + G * (U * U), K = P + D * U + w * (U * U), Rt = p + G * (2 * U), ts = D + w * (2 * U);
    v += b[V] * (Rt * Rt + ts * ts) / (q * q + K * K);
  }
  const X = v * v * v;
  let H = null;
  if (Math.min(X * 25e-7, 0.03) * g < e)
    ...
    const [V, U] = m.subdivide(s, 0.5);
    return fs(V, e * 0.5, i + 1) + fs(U, e * 0.5, i + 1);
  }
  let F = 0;
  for (let V = 0; V < H.length; V += 2) {
    const U = H[V + 1], q = H[V], K = M + G * (U * U), Rt = P + w * (U * U), ts = Math.hypot(K + p * U, Rt + D * U), dn = Math.hypot(K - p * U, Rt - D * U);
    F += q * (ts + dn);
  }
  return 1.5 * F;
}
const Th = {
  ...
  MOTION_PATH: (s, e, i, n) => {
    ...
    if (!a && !_) {
      const E = h[0] - r[0], l = h[1] - r[1], [f, T] = zi(s, r[0], r[1], h[0], h[1]);
      if (E || l) {
      ...
      const E = [...r, ...o, ...c, ...h], l = new m().initWithPointsAndHandlesN(
        E[0],
        E[1],
        E[2],
        E[3],
      ...
      if (s < 0) {
        ...
        if (!N) throw new Error("pos is null");
        const d = f * Math.abs(n[1]), O = l.getTangentAtTime(0);
        if (!O) throw new Error("tangent is null");
        const A = Math.atan2(O.y, O.x);
        return N.add(O.scale(d * s)), {
          pos: [N.x, N.y],
          in: [0, 0],
          out: [0, 0],
          orientRotation: A
        ...
        if (!N) throw new Error("pos is null");
        if (!n[3]) throw new Error("easing[3] is undefined");
        const d = f * (n[3] - 1), O = l.getTangentAtTime(1);
        if (!O) throw new Error("tangent is null");
        const A = Math.atan2(O.y, O.x);
        return N.add(O.scale(d * (s - 1))), {
          pos: [N.x, N.y],
          in: [0, 0],
          out: [0, 0],
          orientRotation: A
        ...
        const N = l.getTimeAt(T);
        if (N === null) throw new Error("t is null");
        const d = l.getPointAtTime(N);
        if (!d) throw new Error("pos is null");
  ...
  PAINT: (s, e, i) => {
    const n = {
      ...
      gradient: {
        stops: [],
        transform: [...e.gradient.transform]
      },
      image: {
        id: e.image.id,
        mode: e.image.mode
    ...
    switch (e.type) {
      case gt.SOLID: {
        n.color = [
          e.color[0] + (i.color[0] - e.color[0]) * s,
          e.color[1] + (i.color[1] - e.color[1]) * s,
          e.color[2] + (i.color[2] - e.color[2]) * s,
          e.color[3] + (i.color[3] - e.color[3]) * s
        ];
        break;
      }
      ...
      case gt.GRADIENT_DIAMOND: {
        const r = [...e.gradient.stops], h = [...i.gradient.stops], o = r.length, c = h.length;
        o > c ? Hi(r, h) : c > o && Hi(h, r);
        const a = r.length;
        for (let E = 0; E < a; E++)
          n.gradient.stops.push({
            position: r[E].position + (h[E].position - r[E].position) * s,
            color: [
              r[E].color[0] + (h[E].color[0] - r[E].color[0]) * s,
              r[E].color[1] + (h[E].color[1] - r[E].color[1]) * s,
              r[E].color[2] + (h[E].color[2] - r[E].color[2]) * s,
              r[E].color[3] + (h[E].color[3] - r[E].color[3]) * s
            ]
          }), n.gradient.stops[E].position = r[E].position + (h[E].position - r[E].position) * s;
        const _ = e.gradient.transform.length ? [...e.gradient.transform] : [0, -1, 1, 0, 0, 1], u = [...i.gradient.transform];
      ...
      case gt.IMAGE: {
        e.image.id ? n.image.id = e.image.id : n.image.id = i.image.id, e.image.mode ? n.image.mode = e.image.mode : n.image.mode = i.image.mode;
        break;
      }
    }
    return n;
  ...
  const s = new Hn();
  return Object.entries(Th).forEach(
    ([e, i]) => {
      const n = Yi({
        name: e,
        interpolate: i
...
var bt = /* @__PURE__ */ ((s) => (s.PAINT = "paint", s.WIDTH = "width", s.HEIGHT = "height", s.ROTATION = "rotation", s.OPACITY = "opacity", s.FILL = "fill", s.STROKE = "stroke", s.SHADOW = "shadow", s.INNER_SHADOW = "innerShadow", s.MOTION_PATH = "motionPath", s.CONTENT_ANCHOR = "contentAnchor", s.GAP = "gap", s.DASH = "dash", s.SCALE_X = "scaleX", s.SCALE_Y = "scaleY", s.SKEW_X = "skewX", s.SKEW_Y = "skewY", s.CORNER_RADIUS = "cornerRadius", s.BLEND_MODE = "blendMode", s.JOIN = "join", s.MITER = "miter", s.ENDS = "ends", s.PATH_MORPHING = "pathMorphing", s))(bt || {}), jt = /* @__PURE__ */ ((s) => (s[s.NON_REPEATABLE = 0] = "NON_REPEATABLE", s[s.REPEATABLE = 1] = "REPEATABLE", s[s.EFFECT = 2] = "EFFECT", s[s.CUSTOM = 3] = "CUSTOM", s))(jt || {});
const Ih = (s) => {
  const e = s.split(".");
  if (e.length === 4) {
    const i = e[0], n = e[1], r = Number(e[2]), h = e[3];
    let o;
    if (n in gh)
      o = 1;
    else
      throw new Error(`[parsePropertyTrackKey] unsupported key: ${s}`);
    return {
      elementId: i,
      layerPropKey: n,
      layerIndex: r,
...
class Mh extends kn {
  ...
  /**
   * Set the computed result from animation composer to Web (HTML/CSS/JS) instances
   * @param trackKey - The track key to set the computed data for
   * @param value - The value to set the computed data for
   */
  setComputedData(i, n) {
    super.setComputedData(i, n);
    const r = Ih(i);
    switch (r.propType) {
      case jt.REPEATABLE: {
        const { elementId: h, propKey: o, layerIndex: c, layerPropKey: a } = r, _ = this.rootElement.querySelector(
          `[id="${h}-${a}-${c}"]`
        );
        switch (a) {
          case "fills": {
            switch (o) {
              case bt.PAINT: {
                const E = n.color;
                (_ == null ? void 0 : _.localName) === "path" ? _.setAttribute(
                  "fill",
                  `rgba(${E[0] * 255}, ${E[1] * 255}, ${E[2] * 255}, ${E[3]})`
                ) : (_ == null ? void 0 : _.localName) === "div" && (_.style.backgroundColor = `rgba(${E[0] * 255}, ${E[1] * 255}, ${E[2] * 255}, ${E[3]})`);
                break;
              }
              case bt.OPACITY: {
                const u = n;
                (_ == null ? void 0 : _.localName) === "path" ? _.setAttribute("opacity", u.toString()) : (_ == null ? void 0 : _.localName) === "div" && (_.style.opacity = u.toString());
                break;
              }
            }
            break;
            ...
            switch (o) {
              case bt.PAINT: {
                ...
                (_ == null ? void 0 : _.localName) === "path" ? _.setAttribute(
                  "stroke",
                  `rgba(${E[0] * 255}, ${E[1] * 255}, ${E[2] * 255}, ${E[3]})`
                ) : (_ == null ? void 0 : _.localName) === "div" && (_.style.borderColor = `rgba(${E[0] * 255}, ${E[1] * 255}, ${E[2] * 255}, ${E[3]})`);
                break;
              }
            }
            break;
      ...
      case jt.EFFECT:
        break;
      case jt.NON_REPEATABLE: {
        const { elementId: h, propKey: o } = r, c = this.rootElement.querySelector(`[id="${h}"]`);
        switch (o) {
          case bt.MOTION_PATH: {
            const a = n;
            if (c) {
...
const Lh = (s, e) => {
  ...
  const n = e[0].split("(")[1].split(",").map(i), r = e[1].split("(")[1].split(",").map(i), h = e[2].split("(")[1].split(",").map(i), o = e[3].split("(")[1].split(",").map(i), c = e[4].split("(")[1].split(",").map(i);
  return {
    translate: { x: n[0], y: n[1] },
    rotate: r[0],
    skew: { x: h[0], y: h[1] },
    scale: { x: o[0], y: o[1] },
    pivot: { x: c[0], y: c[1] }
